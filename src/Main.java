...
//        String projectFilePath = "/Users/laphael/Desktop/project.xml";
...
//        System.out.println(projectFilePath);
        ...
        try {
            ...
            String gsa_accession = "PRJCA005870";
            int grant_id = 1;
//            System.out.println(proPackage.getLength());
            for (int i = 0; i < proPackage.getLength(); i++) {
                ...
                if(TopSingleE==null&&TopAdminE==null){
                    //gsa_accession
//                    String newGsaAccession = addPrjAcc(gsa_accession);
//                    gsa_accession = newGsaAccession;
                    //accession
                    ...
                    String secondId =e.getAttribute("id");
//                    System.out.println(accession);

                    NodeList descrList= packE.getElementsByTagName("ProjectDescr");
                    Element descNode = (Element)descrList.item(0);

//                NodeList prj_name_list = descNode.getElementsByTagName("Name");
//                Element nameE = (Element) prj_name_list.item(0);
//                String name = "";
//                if(nameE!=null){
...
//                    System.out.println("release="+release+release_flag);
                    ...
                    NodeList createList= packE.getElementsByTagName("Submission");
                    Element createE = (Element) createList.item(0);
                    String createTime =createE.getAttribute("submitted");
                    int create_flag = 1;
                    if(createTime==null||createTime.equals("")){
                        createTime = "2015-01-01";
                        create_flag = 0;
                    }
                    NodeList orgList= createE.getElementsByTagName("Organization");
...
//                    String insertSql = "insert into project(accession,second_accession,sample_scope_id,data_type_id,user_id,create_time,release_time,status,title,description,relevance,release_state,release_flag,create_flag)";
                    String insertSql ="";
                    if(organism.equals("{}")){
                        insertSql = "insert into project(second_id,second_accession,sample_scope_id,data_type_id,user_id,create_time,release_time,status,title,description,relevance,release_state,release_flag,create_flag,organization)";
                    } else {
                        insertSql = "insert into project(second_id,second_accession,sample_scope_id,data_type_id,user_id,create_time,release_time,status,title,description,relevance,release_state,release_flag,create_flag,organization,organism)";
                    }
...
//                            insertSql = insertSql +" values('"+newGsaAccession+"','"+accession+"',"+sample_scope_id+","+data_type_id+",2930,'"+createTime+"','"+release+"',3,'"+title+"',";
                            insertSql = insertSql +" values("+secondId+",'"+accession+"',"+sample_scope_id+","+data_type_id+",2930,'"+createTime+"','"+release+"',3,'"+title+"',";
                        } else {
//                            insertSql = insertSql +" values('"+newGsaAccession+"','"+accession+"',"+sample_scope_id+","+data_type_id+",2930,'"+createTime+"','"+release+"',3,'"+title+"',";
                            insertSql = insertSql +" values("+secondId+",'"+accession+"',"+sample_scope_id+","+data_type_id+",2930,'"+createTime+"','"+release+"',3,'"+title+"',";
                        }
